...
function getLocalReminders(): Reminder[] {
  ...
  const seed: Reminder[] = [
    {
      ...
      issuerBank: 'Chase',
      last4Digits: '4821',
      statementDate: new Date(Date.now() + 15 * 86400000).toISOString(),
      paymentDueDate: new Date(Date.now() + 25 * 86400000).toISOString(),
    ...
    {
      id: 'demo-2',
      title: 'Wells Fargo $300 Checking Bonus',
      reminderType: 'bank_offer',
      issuerBank: 'Wells Fargo',
      estimatedSavings: 300,
      renewalDate: new Date(Date.now() + 45 * 86400000).toISOString(),
      milestones: [
        { id: '1', title: 'Open account with $25 minimum deposit', completed: true },
        { id: '2', title: 'Receive $1,000 in qualifying direct deposits within 90 days', completed: false },
        { id: '3', title: 'Maintain account open for 90 days to receive bonus', completed: false },
      ],
    ...
    },
    {
      ...
      notes: 'Free 1-year trial ends! Bring student transcript or ID to local branch to convert to student checking to avoid $12/month fee.',
      milestones: [
        { id: '1', title: 'Download student enrollment verification PDF', completed: true },
        { id: '2', title: 'Visit branch or message in-app support to switch tier', completed: false },
        { id: '3', title: 'Confirm $0 monthly fee on next statement', completed: false },
      ],
      remindDaysBefore: [14, 7, 2, 1],
      autoRenew: false,
      status: 'active',
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
    },
    {
      ...
      amount: 348.0,
      currency: 'USD',
      renewalDate: new Date(Date.now() + 8 * 86400000).toISOString(),
      notes: '30-day return window ends soon. Return with box and accessories.',
      remindDaysBefore: [7, 3, 1],
      autoRenew: false,
      status: 'active',
      createdAt: new Date().toISOString(),
    ...
    },
    {
      ...
      amount: 22.99,
      currency: 'USD',
      renewalDate: new Date(Date.now() + 19 * 86400000).toISOString(),
  ...
  localStorage.setItem(LOCAL_STORAGE_REMINDERS_KEY, JSON.stringify(seed));
  return seed;
}
