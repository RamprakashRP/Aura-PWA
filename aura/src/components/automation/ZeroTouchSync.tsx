...
export function ZeroTouchSync() {
  ...
  return (
    <div className="space-y-6 text-slate-100">
      {/* Top Header Card */}
      <div className="p-5 rounded-2xl bg-slate-900/90 border border-slate-800 backdrop-blur-xl shadow-2xl flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-950 border border-slate-800 text-xs font-mono">
          ...
          <span className="text-slate-400">Webhook Node:</span>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
        ...
        >
          ...
          <div className="text-[10px] text-slate-400 mt-0.5">Instant background shortcut</div>
        </button>
        ...
        >
          ...
          <div className="text-[10px] text-slate-400 mt-0.5">Notification auto-bridge</div>
        </button>
        ...
        >
          ...
          <div className="text-[10px] text-slate-400 mt-0.5">Gmail / Outlook forwarding</div>
        </button>
        ...
        >
          ...
          <div className="text-[10px] text-slate-400 mt-0.5">Plaid / Flinks connector</div>
        </button>
      </div>
          ...
          <div className="space-y-3 text-xs">
            <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-800 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-slate-400 mt-0.5">Tap the <b>Automation</b> tab at the bottom $ightarrow$ Tap <b>+ (New Automation)</b>.</p>
              </div>
            </div>
            ...
            <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-800 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-slate-400 mt-0.5">Choose <b>Any Card</b> (or select your RBC / TD / Scotia / Tangerine card) $ightarrow$ Select <b>Run Immediately (No confirmation)</b>.</p>
              </div>
            </div>
            ...
            <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-800 flex items-start gap-3">
              ...
              <div className="w-full">
                ...
                <p className="text-slate-400 mt-0.5 mb-2">Set Method to <b>POST</b> and paste your webhook endpoint URL:</p>
                <div className="flex items-center justify-between p-2 rounded-lg bg-slate-900 border border-slate-700 font-mono text-[11px] text-cyan-300">
          ...
          <div className="space-y-3 text-xs">
            <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-800 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-slate-400 mt-0.5">MacroDroid is a lightweight Android automation app with zero battery impact.</p>
              </div>
            </div>
            ...
            <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-800 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-slate-400 mt-0.5">Select Google Wallet, TD, RBC, or Scotiabank as the monitored notification source.</p>
              </div>
            </div>
            ...
            <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-800 flex items-start gap-3">
              ...
              <div className="w-full">
                ...
                <p className="text-slate-400 mt-0.5 mb-2">Send notification title and body directly to your endpoint:</p>
                <div className="flex items-center justify-between p-2 rounded-lg bg-slate-900 border border-slate-700 font-mono text-[11px] text-cyan-300">
                  <span className="truncate">{webhookUrl}</span>
                  <button
                    type="button"
      ...
      {activeChannel === 'email' && (
        <div className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-5">
          ...
          <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 text-xs space-y-3">
            ...
            <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-700 font-mono text-[11px] text-slate-300">
